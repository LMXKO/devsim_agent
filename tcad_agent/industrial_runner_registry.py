...
def industrial_runner_descriptors() -> list[IndustrialRunnerDescriptor]:
    return [
        ...
        IndustrialRunnerDescriptor(
            ...
            command="python3.11 -m tcad_agent.industrial_external_runner --template-id gan_hemt_id_bv --simulator sentaurus --project <USER_OWNED_PROJECT>",
        ...
        IndustrialRunnerDescriptor(
            ...
            command="python3.11 -m tcad_agent.industrial_external_runner --template-id sic_power_diode_bv_leakage --simulator sentaurus --project <USER_OWNED_PROJECT>",
            maturity=RunnerMaturity.REAL_EXTERNAL,
            dimensionality="external_2d_or_3d",
            solver_backend="sentaurus_external_workspace",
            solver_invoked=True,
        ...
        IndustrialRunnerDescriptor(
            ...
            command="python3.11 -m tcad_agent.industrial_external_runner --template-id igbt_output_turnoff --simulator sentaurus --project <USER_OWNED_PROJECT>",
            maturity=RunnerMaturity.REAL_EXTERNAL,
