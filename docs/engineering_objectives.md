...
`tcad_agent.tools.engineering_objectives` evaluates engineering constraints and Pareto objectives over TCAD result states.
...
```bash
python3.11 -m tcad_agent.tools.engineering_objectives \
